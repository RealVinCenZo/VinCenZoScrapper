...
def banner():
    ...
    #print('=============SON OF KING==============')
    print(f'{lg}   Version: {w}1.6{lg} | Author: {w}@XD_RAJVEER{rs}\n')
...
while True:
    ...
    print(lg+'[4] Update your VinCenZo Scrapper'+n)
    print(lg+'[5] Quit'+n)
    a = int(input('\nEnter your choice: '))
    if a == 1:
        new_accs = []
        ...
        try:
            # https://raw.githubusercontent.com/RealVinCenZo/VinCenZoScrapper/RealVinCenZo/version.txt
            version = requests.get('https://raw.githubusercontent.com/RealVinCenZo/VinCenZoScrapper/RealVinCenZo/version.txt')
        except:
        ...
        if float(version.text) > 1.1:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                os.system('curl -l -O https://raw.githubusercontent.com/RealVinCenZo/VinCenZoScrapper/RealVinCenZo/version.txt')
                os.system('curl -l -O https://raw.githubusercontent.com/RealVinCenZo/VinCenZoScrapper/RealVinCenZo/version.txt')
            ...
            print(f'{lg}[i] Your VinCenZo scrapper is already up to date')
